...
// generamos una base de datosBD
let id = 1,
  name = 'null',
  age = null,
  tdateCreated = null,
  tdateModified = null;
const DB = [{id: 0, name, age, tdateCreated, tdateModified}];
// cuando ingresemos a localhost:3000/
// nos mostrara BD
  ...
  if (req.body.name == null || req.body.age == null) {
    ...
    if (req.body.age > 119 || req.body.age < 18) {
      ...
      const user = {
        ...
        name: req.body.name,
        age: req.body.age,
        tdateCreated: new Date (),
        tdateModified: 'no modificado',
      };
...
app.get ('/api/userName', (req, res) => {
  ...
  res.json (DB.sort (comparacion));
  console.log (DB.sort (comparacion));
});
